...
const CategoryPage = () => {
    ...
    const fetchCategory = async () => {
        try {
            ...
            // Ensure responseData is valid before accessing data
    ...
    return (
        <section className=''>
            ...
            {/* Display NoData component when there's no data and loading is false */}
            ...
            {/* Display Loading component when data is being fetched */}
            {loading && (
                <Loading />
            )}

            {/* Modal for Upload Category */}
            {openUploadCategory && (
